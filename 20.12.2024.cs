...
namespace Donkeykong
{
    public class Programm
    {
        ...
        public static char Jumpmovement;
        public static bool Walklock = false;
        ...
        public static void Main()
        {
            ...
            Thread a = new Thread(MarioControll);
            Thread d = new Thread(steuerung);
            a.Start();
            d.Start();
        }
        ...
        public static void steuerung()
        {
            while (GameRunning == true)
            {
                ...
                Steuerung = Console.ReadKey(true).KeyChar;
                switch (Steuerung)
                {
                    case ' ':
                        ...
                        else
                        {
                            ...
                            repeats++;
                            Thread.Sleep(50);
                            if (Console.KeyAvailable == true && repeats < 20)
                            {
                                Jumpmovement = Console.ReadKey(true).KeyChar;
                                switch (Jumpmovement)
                                {
                                    case 'd':
